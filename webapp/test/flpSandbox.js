		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Suppliers",
									"targetURL": "#nsnsbusinesspartners-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsnsbusinesspartners-display": {
								"semanticObject": "nsnsbusinesspartners",
								"action": "display",
								"description": "Our Suppliers",
								"title": "Suppliers",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.nsbusinesspartners",
									"url": sap.ui.require.toUrl("ns/nsbusinesspartners")
								}
							}
						}
					}
